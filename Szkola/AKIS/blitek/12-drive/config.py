...
class Config:
    ...
    # maksymalny rozmiar pliku do wysłania (domyślnie 200 MB)
    ...
    STORAGE_ROOT = DATA_PATH / 'storage' # katalog do przechowywania plików

    # zabezpieczeni sesji
    SESSION_COOKIE_HTTPONLY = True # chroni przed XSS
    ...
    REMEMBER_COOKIE_SECURE = os.environ.get('REMEMBER_COOKIE_SECURE', '0') == '1' # tylko w protokole HTTPS

    # czas wygaśnięcia tokena (1 godzina)
    WTF_CSRF_TIME_LIMIT = 3600

    # token jednorazowy dla utworzenia pierwszego admina
